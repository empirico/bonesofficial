...
abstract class BaseFilesPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Filename', 'Mimetype', 'Size', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'filename', 'mimetype', 'size', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FILENAME, self::MIMETYPE, self::SIZE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FILENAME', 'MIMETYPE', 'SIZE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'filename', 'mimetype', 'size', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Filename' => 1, 'Mimetype' => 2, 'Size' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'filename' => 1, 'mimetype' => 2, 'size' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FILENAME => 1, self::MIMETYPE => 2, self::SIZE => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FILENAME' => 1, 'MIMETYPE' => 2, 'SIZE' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'filename' => 1, 'mimetype' => 2, 'size' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(FilesPeer::MIMETYPE);
	 ...
	 *
	 * @param      Files $value A Files object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Files $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = FilesPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + FilesPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? FilesPeer::CLASS_DEFAULT : FilesPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Files or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(FilesPeer::ID) && $criteria->keyContainsValue(FilesPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.FilesPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Files or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(FilesPeer::ID);
			if ($value) {
				$selectCriteria->add(FilesPeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the files table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			FilesPeer::doOnDeleteSetNull(new Criteria(FilesPeer::DATABASE_NAME), $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Files or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			FilesPeer::doOnDeleteSetNull($c, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$updateValues = new Criteria(FilesPeer::DATABASE_NAME);
			$selectCriteria->add(JournalPostPeer::FILE_ID, $obj->getId());
			$updateValues->add(JournalPostPeer::FILE_ID, null);
