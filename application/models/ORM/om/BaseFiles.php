...
abstract class BaseFiles extends BaseObject  implements Persistent
{
  ...
  const PEER = 'FilesPeer';
	...
	public function setMimetype($v)
	{
		...
		if ($this->mimetype !== $v) {
			$this->mimetype = $v;
			$this->modifiedColumns[] = FilesPeer::MIMETYPE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->mimetype = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = FilesPeer::NUM_COLUMNS - FilesPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(FilesPeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FilesPeer::MIMETYPE)) $criteria->add(FilesPeer::MIMETYPE, $this->mimetype);
	 ...
	 * If this Files is new, it will return
	 ...
	 * @return     PropelCollection|array JournalPost[] List of JournalPost objects
	 */
	public function getJournalPostsJoinJournal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = JournalPostQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Photos[] List of Photos objects
	 */
	public function getPhotossJoinAlbum($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PhotosQuery::create(null, $criteria);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collEventss) {
				foreach ((array) $this->collEventss as $o) {
