...
class Admin_AlbumController extends Bones_Controller_Admin {
    ...
    public function listAction() {
        ...
        $pager = new PropelPager($query,'AlbumPeer','doSelect',$offset, self::PER_PAGE);

		$this->view->pager =  $pager;
		$this->view->offset = $offset;
        $this->view->album_list = $pager->getResult();
    }
    ...
    public function saveAction() {
        ...
        switch ($action) {
            ...
            case 'DEL' : {
                $album->delete();
                $url = $this->view->url(array('action' => 'list', 'galleryId' => $params['galleryId']));
            }
            break;
            case 'ADDPHOTO': {
